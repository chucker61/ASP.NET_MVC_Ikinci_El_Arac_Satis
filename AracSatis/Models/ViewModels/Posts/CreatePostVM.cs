...
namespace AracSatis.Models.ViewModels.Posts
{
    public class CreatePostVM
    {
        ...
        [StringLength(100, MinimumLength = 28, ErrorMessage = "Başlık en az 10, en fazla 30 karakter içermeli")]
        public string Title { get; set; }

        [System.ComponentModel.DataAnnotations.Required(ErrorMessage = "İlanınızın açıklamasını girin.")]
        [StringLength(5000, MinimumLength =50, ErrorMessage ="Açıklama en az 30, en fazla 200 karakter içermeli")]
        ...
        public List<IFormFile> SelectedImages { get; set; } = new List<IFormFile>();
